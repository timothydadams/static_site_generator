...
class TestSplitNodesWithImages(unittest.TestCase):
...
class TestMarkdownLinks(unittest.TestCase):
    def test_extract_markdown_links(self):
        matches = extract_markdown_links(
            "A decent search engine is [Duck Duck Go](https://duckduckgo.com)"
        )
        self.assertListEqual([("Duck Duck Go", "https://duckduckgo.com")], matches)

    def test_multiple_links(self):
        matches = extract_markdown_links(
            "This is text with a [link1](https://www.google.com) and [link2](https://www.made-up-url.com)"
        )
        self.assertListEqual(
            [
                ("link1", "https://www.google.com"),
                ("link2", "https://www.made-up-url.com"),
            ],
            matches,
        )
